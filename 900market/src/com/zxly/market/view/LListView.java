...
/**
 * Created by Yangwencai on 2015/4/27.
 */
            ...
            v.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    if (onItemClickListener != null) {
                        onItemClickListener.onItemClick(LListView.this, layout, index,
                                adapter.getItem(index));
                    }
                }
            });
//            ImageView imageView = new ImageView(getContext());
//            imageView.setBackgroundResource(R.color.c_grey_c5c5c5);
...
//            layout.addView(imageView);
     ...
     * @param onClickListener
     */
    public void setOnItemClickListener(LOnItemClickListener onClickListener) {
...
//    }
    ...
    public static interface LOnItemClickListener {

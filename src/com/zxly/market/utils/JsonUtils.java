...
public class JsonUtils {
    ...
    public static String toJson(Object target, Type targetType,
        ...
        try {
            ...
            Logger.w("gson", "目标对象 " + target.getClass().getName()
    ...
    public static <T> T fromJson(String json, TypeToken<T> token,
        ...
        try {
            ...
            Logger.w("gson", json + " 无法转换为 " + token.getRawType().getName() + " 对象!",
                    ex);
            return null;
        }
    }
    ...
    public static <T> T fromJson(String json, Class<T> clazz, String datePattern) {
        ...
        try {
            ...
            Logger.w("gson", json + " 无法转换为 " + clazz.getName() + " 对象!", ex);
            return null;
        }
    }
     ...
     * @return
     */
    public static <T> List<T> listFromJson(String json, TypeToken<List<T>> type) {
        try {
            JSONObject object = new JSONObject(json);
            if(object==null)return null;
            Data data = new Data();
            data.setStatus(object.optInt("status"));
            data.setStatusText(object.optString("statusText"));
            if(data.getStatus() != 200)return null;
            JSONArray array = object.getJSONArray("apkList");
            //TypeToken<List<T>> type = new TypeToken<List<T>>(){};
            return JsonUtils.fromJson(array.toString(),type);
    ...
    public static Data dataFromJson(String json) {
        if(!CommonUtils.validate(json))return null;
        TypeToken<Data> type = new TypeToken<Data>(){};

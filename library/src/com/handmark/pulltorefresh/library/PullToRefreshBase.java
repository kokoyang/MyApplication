	...
	public final void onRefreshComplete() {
		if (isRefreshing()) {
			...
			if (mHeaderLayout != null) {
				mHeaderLayout.setHeaderImageVisible(View.INVISIBLE);
				mHeaderLayout.setHeaderTextVisible(View.INVISIBLE);
				mHeaderLayout.setProgressBarVisible(View.INVISIBLE);
			}

			if (mFooterLayout != null) {
				mFooterLayout.setHeaderImageVisible(View.INVISIBLE);
				mFooterLayout.setHeaderTextVisible(View.INVISIBLE);
				mFooterLayout.setProgressBarVisible(View.INVISIBLE);
			}
